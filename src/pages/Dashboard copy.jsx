...
export default function Dashboard() {
  ...
  const projects = [
    ...
    },
    {
      ...
      icon: Camera,
      link: "https://drive.google.com/file/d/1aJ7iXszVyV8Oh2zvpDvQ0qqnToZx_rqh/view?usp=sharing",
      tech: "React.js • Node.js • Python • InsightFace ( buffalo_l model ) • pgvector • RAG • PostgreSQL",
    },
    {
